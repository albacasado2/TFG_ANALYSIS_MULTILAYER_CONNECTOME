1%primero cargamos la informacion de PRUEBA_MATRIZ_TODA_LA_RED para tener la
%matriz de adjacencia generica y así ahora depsues tratarla con diferentes
%algoritmos para ver los resultados

girvan_modules_synap=table2cell(readtable("girvan_modulos_gap.txt",'Delimiter',',','NumHeaderLines',0));
...
figure;
subplot(9,1,1)
module_1=table2cell(readtable("D:\TFG\S1 Dataset. Included are edge lists and source data for monoamine and neuropeptide networks\DATOS S1\edge_lists\girvan_modulos_gap\girvan_modulos_gap_1.txt",'Delimiter',',','NumHeaderLines',0));
module_1=cell2mat(module_1);
[a1,fun_mod1]=plotear_por_funcion(module_1);
    
subplot(9,1,2)
module_2=table2cell(readtable("D:\TFG\S1 Dataset. Included are edge lists and source data for monoamine and neuropeptide networks\DATOS S1\edge_lists\girvan_modulos_gap\girvan_modulos_gap_2.txt",'Delimiter',',','NumHeaderLines',0));
module_2=cell2mat(module_2);
[a2,fun_mod2]=plotear_por_funcion(module_2);

subplot(9,1,3)
module_3=table2cell(readtable("D:\TFG\S1 Dataset. Included are edge lists and source data for monoamine and neuropeptide networks\DATOS S1\edge_lists\girvan_modulos_gap\girvan_modulos_gap_3.txt",'Delimiter',',','NumHeaderLines',0));
module_3=cell2mat(module_3);
[a3,fun_mod3]=plotear_por_funcion(module_3);

subplot(9,1,4)
module_4=table2cell(readtable("D:\TFG\S1 Dataset. Included are edge lists and source data for monoamine and neuropeptide networks\DATOS S1\edge_lists\girvan_modulos_gap\girvan_modulos_gap_4.txt",'Delimiter',',','NumHeaderLines',0));
module_4=cell2mat(module_4);
[a4,fun_mod4]=plotear_por_funcion(module_4);

subplot(9,1,5)
module_5=table2cell(readtable("D:\TFG\S1 Dataset. Included are edge lists and source data for monoamine and neuropeptide networks\DATOS S1\edge_lists\girvan_modulos_gap\girvan_modulos_gap_5.txt",'Delimiter',',','NumHeaderLines',0));
module_5=cell2mat(module_5);
[a5,fun_mod5]=plotear_por_funcion(module_5);

subplot(9,1,6)
module_6=table2cell(readtable("D:\TFG\S1 Dataset. Included are edge lists and source data for monoamine and neuropeptide networks\DATOS S1\edge_lists\girvan_modulos_gap\girvan_modulos_gap_6.txt",'Delimiter',',','NumHeaderLines',0));
module_6=cell2mat(module_6);
[a6,fun_mod6]=plotear_por_funcion(module_6);

subplot(9,1,7)
module_7=table2cell(readtable("D:\TFG\S1 Dataset. Included are edge lists and source data for monoamine and neuropeptide networks\DATOS S1\edge_lists\girvan_modulos_gap\girvan_modulos_gap_7.txt",'Delimiter',',','NumHeaderLines',0));
module_7=cell2mat(module_7);
[a7,fun_mod7]=plotear_por_funcion(module_7);

subplot(9,1,8)
module_8=table2cell(readtable("D:\TFG\S1 Dataset. Included are edge lists and source data for monoamine and neuropeptide networks\DATOS S1\edge_lists\girvan_modulos_gap\girvan_modulos_gap_8.txt",'Delimiter',',','NumHeaderLines',0));
module_8=cell2mat(module_8);
[a8,fun_mod8]=plotear_por_funcion(module_8);

subplot(9,1,9)
module_9=table2cell(readtable("D:\TFG\S1 Dataset. Included are edge lists and source data for monoamine and neuropeptide networks\DATOS S1\edge_lists\girvan_modulos_gap\girvan_modulos_gap_9.txt",'Delimiter',',','NumHeaderLines',0));
